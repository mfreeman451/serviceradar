...
// Source: github.com/carverauto/serviceradar/pkg/cloud/api (interfaces: Service)
//
// Generated by this command:
//
//	mockgen -destination=mock_api_server.go -package=api github.com/carverauto/serviceradar/pkg/cloud/api Service
//
